...
export function createKillerBunniesPlayableCard(catalogCard) {
  ...
  if (catalogCard.kind === "bunny") {
    return { ...common, kind: "bunny", type: "RUN", color: catalogCard.color || gameColorFor(catalogCard.deckId), detail: catalogCard.detail };
  }
  ...
  if (catalogCard.kind === "modifier") {
    return { ...common, kind: "action", originalKind: "modifier", type: "SPECIAL", color: catalogCard.color, detail: catalogCard.detail, effectImplemented: false };
  }
  ...
  return {
    ...
    type: catalogCard.type === "SPECIAL" ? "SPECIAL" : "RUN",
...
function gameColorFor(deckId) {
  if (deckId.includes("red")) return "red";
  if (deckId.includes("green") || deckId.includes("robot") || deckId.includes("creature")) return "green";
  if (deckId.includes("violet") || deckId.includes("onyx") || deckId.includes("fantastic")) return "violet";
  if (deckId.includes("pink")) return "pink";
  if (deckId.includes("orange") || deckId.includes("pumpkin")) return "orange";
  return "blue";
}
