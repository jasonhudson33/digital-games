...
function dealRound(game, rng) {
  ...
  let next = {
    ...
    deck,
    discard: [opening],
    /* Who to credit the top of the discard to, so a seated table can show a
       card in front of whoever put it down. Nobody played the opening flip,
       so there is no seat to point it at. */
    lastPlayerId: null,
