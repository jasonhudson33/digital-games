...
const CARD_SPECS = [
  // Period A: 7 characters, 17 buildings, 6 techniques.
  character("A", "bureaucrat", "Bureaucrat", 0, "Gain VP equal to a numbered token.", 1, true),
  ...
  character("A", "architect", "Architect", 0, "Pay a numbered token to use the residence track.", 2, true),
  building("A", "mine-small", "Coal-Shaft Mine", 2, ["mine"], 0, "Use 1 worker to gain 1 Spyrium.", 2, [{ workers: 1, spyrium: 0, gainSpyrium: 1 }]),
  building("A", "mine", "Spyrium Mine", 5, ["mine"], 0, "Gain 1 Spyrium, or use 1 worker to gain 2.", 3, [{ workers: 0, spyrium: 0, gainSpyrium: 1 }, { workers: 1, spyrium: 0, gainSpyrium: 2 }]),
  building("A", "workshop", "Workshop", 2, ["factory"], 2, "Use 1 worker and 1 Spyrium to gain 3 VP.", 3, [{ workers: 1, spyrium: 1, gainScore: 3 }]),
  building("A", "workshop-b", "Powered Workshop", 4, ["factory"], 3, "Use 1 worker and 2 Spyrium to gain 5 VP.", 2, [{ workers: 1, spyrium: 2, gainScore: 5 }]),
  building("A", "laboratory", "Laboratory", 5, ["factory", "research"], 1, "Use 1 worker and 1 Spyrium to gain 4 VP.", 1, [{ workers: 1, spyrium: 1, gainScore: 4 }]),
  building("A", "neighborhood", "Working-Class Neighborhood", 5, ["residence"], 3, "Immediately recruit 1 worker.", 3, [], { recruit: 1 }),
  building("A", "residence", "Residence", 3, ["residence"], 2, "Immediately use the residence track.", 2, [], { residence: true }),
  building("A", "university", "University", 2, ["research"], 0, "Use 1 worker to gain 2 VP. Its token scores when built.", 1, [{ workers: 1, spyrium: 0, gainScore: 2 }], { token: true }),
  technique("A", "commerce", "Commerce", 6, "Keep activated tokens. Once per round choose a token value. End: 1 VP per kept token."),
  technique("A", "lobbying", "Lobbying", 6, "Once each round, ignore congestion when activating a market card. End: residence-track VP."),
  technique("A", "automation", "Automation", 6, "Mines no longer require workers. End: 1 VP per Spyrium."),
  technique("A", "capitalization", "Capitalization", 6, "Gain £2 extra when withdrawing for money. End: 1 VP per £2."),
  technique("A", "engineering", "Engineering", 6, "Factory buildings score 1 extra VP per worker used. End: VP equal to their printed value."),
  technique("A", "crane", "Crane", 6, "New building spaces cost £3 less. End: 1 VP per building."),

  // Period B: 6 characters, 13 buildings, 1 technique.
  character("B", "bureaucrat", "Bureaucrat", 0, "Gain VP equal to a numbered token.", 1, true),
  character("B", "miner", "Miner", 0, "Take Spyrium equal to a numbered token.", 1, true),
  character("B", "engineer", "Engineer", 0, "Spend 1 Spyrium to gain 4 VP.", 1),
  character("B", "architect", "Architect", 0, "Pay a numbered token to use the residence track.", 1, true),
  character("B", "geologist", "Geologist", 0, "Gain 2 Spyrium.", 1),
  character("B", "banker", "Banker", 0, "Pay a numbered token to gain 4 VP.", 1, true),
  building("B", "mine-rich", "Deep Spyrium Mine", 7, ["mine"], 0, "Gain 1 Spyrium, or use 1 worker to gain 3. Its token pays Spyrium when built.", 2, [{ workers: 0, spyrium: 0, gainSpyrium: 1 }, { workers: 1, spyrium: 0, gainSpyrium: 3 }], { token: true }),
  building("B", "factory", "Factory", 6, ["factory"], 4, "Use 1 worker + 2 Spyrium for 6 VP, or 2 workers + 3 Spyrium for 10 VP.", 2, [{ workers: 1, spyrium: 2, gainScore: 6 }, { workers: 2, spyrium: 3, gainScore: 10 }]),
  building("B", "factory-c", "Grand Factory", 8, ["factory"], 5, "Use 2 workers + 3 Spyrium for 10 VP, or 2 workers + 5 Spyrium for 15 VP.", 1, [{ workers: 2, spyrium: 3, gainScore: 10 }, { workers: 2, spyrium: 5, gainScore: 15 }]),
  building("B", "laboratory-b", "Advanced Laboratory", 6, ["factory", "research"], 2, "Use 1 worker and 1 Spyrium to gain 5 VP.", 1, [{ workers: 1, spyrium: 1, gainScore: 5 }]),
  building("B", "laboratory-c", "Royal Laboratory", 7, ["factory", "research"], 2, "Use 1 worker and 2 Spyrium to gain 7 VP.", 1, [{ workers: 1, spyrium: 2, gainScore: 7 }]),
  building("B", "neighborhood-b", "Industrial Neighborhood", 6, ["residence"], 4, "Immediately recruit 2 workers.", 2, [], { recruit: 2 }),
  building("B", "residence", "Residence", 3, ["residence"], 2, "Immediately use the residence track.", 1, [], { residence: true }),
  building("B", "residence-b", "Grand Residence", 5, ["residence"], 4, "Immediately use the residence track.", 2, [], { residence: true }),
  building("B", "university-b", "Royal University", 5, ["research"], 0, "Use 1 worker for 3 VP, or 2 workers for 6 VP. Its token scores when built.", 1, [{ workers: 1, spyrium: 0, gainScore: 3 }, { workers: 2, spyrium: 0, gainScore: 6 }], { token: true }),
  technique("B", "taylorism", "Taylorism", 6, "Once each round, ready and immediately reuse a building. End: 1 VP per worker."),

  // Period C: 4 characters and 5 buildings. Every card is used.
  character("C", "engineer", "Master Engineer", 0, "Spend 1 Spyrium to gain 4 VP.", 1),
  character("C", "adviser", "Adviser", 0, "Gain 3 VP.", 1),
  character("C", "geologist", "Geologist", 0, "Gain 2 Spyrium.", 1),
  character("C", "financier", "Financier", 0, "Pay a numbered token to gain 5 VP.", 1, true),
  building("C", "factory-c", "Grand Factory", 8, ["factory"], 5, "Use 2 workers + 3 Spyrium for 10 VP, or 2 workers + 5 Spyrium for 15 VP.", 1, [{ workers: 2, spyrium: 3, gainScore: 10 }, { workers: 2, spyrium: 5, gainScore: 15 }]),
  building("C", "laboratory-c", "Royal Laboratory", 7, ["factory", "research"], 2, "Use 1 worker and 2 Spyrium to gain 7 VP.", 1, [{ workers: 1, spyrium: 2, gainScore: 7 }]),
  building("C", "luxury-home", "Luxury Home", 6, ["residence"], 6, "Worth 6 VP at the end of the game.", 1, []),
  building("C", "mansion", "Mansion", 8, ["residence"], 9, "Worth 9 VP at the end of the game.", 1, []),
  building("C", "palace", "Crystal Palace", 10, ["residence"], 12, "Worth 12 VP at the end of the game.", 1, []),
];

const CARD_ART = {
  "A:architect": "/spyrium/cards/c-architect.png",
  "A:commerce": "/spyrium/cards/c-commerce.png",
  "A:engineering": "/spyrium/cards/b-engineering.png",
  "A:lobbying": "/spyrium/cards/b-lobbying.png",
  "A:workshop-b": "/spyrium/cards/b-workshop-b.png",
  "B:factory-c": "/spyrium/cards/c-factory-c.png",
  "B:geologist": "/spyrium/cards/a-geologist.png",
  "B:laboratory-c": "/spyrium/cards/c-laboratory-c.png",
  "B:miner": "/spyrium/cards/a-miner.png",
  "B:neighborhood-b": "/spyrium/cards/a-neighborhood.png",
  "B:residence": "/spyrium/cards/a-residence.png",
  "C:adviser": "/spyrium/cards/a-adviser.png",
  "C:geologist": "/spyrium/cards/a-geologist.png",
  "C:luxury-home": "/spyrium/cards/a-luxury-home.png",
  "C:mansion": "/spyrium/cards/b-mansion.png",
};
  ...
  for (const spec of CARD_SPECS) {
    for (let copy = 1; copy <= spec.copies; copy += 1) {
      decks[spec.period].push({
        ...
        art: CARD_ART[`${spec.period}:${spec.slug}`] || `/spyrium/cards/${spec.period.toLowerCase()}-${spec.slug}.png`,
        tokens: [],
      });
    }
  }
