...
const BLUE_YELLOW_RULES = new Map([
  ...
  [53, rule("Choose a bunny carrying Clover modifiers. Remove all of its Clovers, then roll to decide whether they may be reassigned or must be discarded.", false)],
  ...
  [65, rule("Declare stakes in supplies, carrots, money, bunnies, or supported expansion items. Eligible players roll; the highest roller wins the pooled stake.", false)],
  ...
  [71, rule("For this turn, buy items from Kaballa’s Market for half price, rounding fractional Dolla up.", false, "guided", ["Kaballa’s Market must be open."])],
  ...
  [134, rule("Abduct any bunny from the Bunny Circle. Return the previously abducted bunny when another abduction takes a new target.", true)],
  [135, rule("Auction any bunny in the Bunny Circle. The highest bidder pays the discard bank and takes the bunny.", false)],
  [136, rule("Roll the Orange d12 or Clear d20 and steal the Carrot with the matching number from its owner or the market.", false)],
  ...
  [141, cloverRule(4)],
  [142, rule("If you have no saved units of a supply, take half of that supply from the opponent holding the most; resolve Cabbage and Water independently.", false, "guided", ["You must have zero units of each supply you want to take."])],
  [143, rule("Every player with an eligible bunny rolls a d12. The lowest roller discards the bunny they entered; the card owner receives one optional reroll.", true)],
  [144, rule("Choose a player. They must pay 2 Dolla per Carrot they keep and return every unpaid Carrot to the market.", false)],
  [145, rule("Cancel Roaches or counter Maggots before your Cabbage is lost.", false, "guided", ["This card must already be saved.", "The threat must affect the card owner."])],
  [146, rule("Take one Cabbage Card and one Water Card from Kaballa’s Market.", false, "automatic", ["Kaballa’s Market must be open."])],
  [147, rule("While saved, double the level and range of every Weapon Level 1-9 you launch; discard this card when you have no living bunny.", true, "manual", ["You need a living bunny to save or retain this card."])],
  [148, rule("Cancel Flame Thrower or counter Drought before your Water is lost.", false, "guided", ["This card must already be saved.", "The threat must affect the card owner."])],
  [149, rule("Exchange a Weapon from your hand with a Weapon in an opponent’s hand or Rooney’s used-weapon inventory.", false, "guided", ["You must have a Weapon in your five-card hand."])],
  ...
  [152, rule("Redirect a Weapon that has just been launched to any other legal bunny target.", false)],
]);

const RED_RULES = new Map([
  [166, rule("Place this Red bunny in your Bunny Circle. It may satisfy up to 3 Cabbage and 3 Water of its own feeding each turn without saved supplies.", false, "manual")],
  [167, rule("Place this Red bunny in your Bunny Circle. While it lives, you receive up to 3 Dolla of spending power at open stores each turn.", false, "manual")],
  ...
  [169, rule("Place this Red bunny in your Bunny Circle. A directly targeted Weapon that fails against it bounces to a bunny owned by the attacker.", false, "manual")],
  [170, rule("Place this Red bunny in your Bunny Circle. Its owner may reroll one die-based action during play.", false, "manual")],
  [175, rule("Choose an opponent. Every bunny they currently control must pay the printed feeding cost by the end of that opponent’s next turn.", true, "manual")],
  [176, rule("Every opponent with a bunny chooses one bunny to pay the printed feeding cost by the end of their next turn.", true, "manual")],
  [181, rule("Launch a clockwise roaming missile. Each visited bunny’s owner rolls the Red d12; a prime result detonates a level-9 attack on the target and level-8 attacks on adjacent bunnies.", true, "manual")],
  [182, rule("Attack the target at level 11, bunnies two spaces away at level 9, and bunnies four spaces away at level 7; wraparound may hit a bunny twice.", true, "manual")],
  [183, rule("Steal The Minilith, or make its holder roll seven colored d12s and surrender a Carrot or bunny for each even result; seven evens punish every player.", false, "manual")],
  ...
  [187, rule("Choose an opponent with at least two Carrots and exchange two Carrots you select from them for one Carrot you select from yourself.", false, "guided", ["You need a Carrot.", "The chosen opponent needs at least two Carrots."])],
  [188, rule("Target a Congenial Bunny and immediately kill the two bunnies adjacent to it; the Congenial target survives.", true, "guided", ["A Congenial Bunny must be available to target."])],
  [189, rule("Hide all Carrots, roll for a Carrot number, and name its owner to steal it; a wrong guess returns one of your Carrots to the market.", false, "guided", ["You must own at least one Carrot."])],
  [190, rule("Eliminate one regular Barrier from the Bunny Circle.", true, "automatic", ["A removable Barrier must be in play."])],
  [191, rule("Place this Holographic Red bunny in your Bunny Circle. It needs no food, cannot satisfy the living-bunny win condition, and is vulnerable only to its listed attacks.", false, "manual")],
  [192, cloverRule(5)],
  [193, rule("Start a rotating d12 contest in which failed rolls donate a bunny or Carrot to a kitty; the first 12 wins the kitty, with a final chance for the initiator.", true, "manual")],
  [194, rule("Choose a player to roll the colored d12s. Kill every bunny matching the lowest color rolled; a Black low roll threatens every vulnerable bunny.", true, "manual")],
  [195, rule("Pay an opponent 5 Dolla to take one eligible Red bunny, Red Pawn, or Fire Zodiac card from them.", false, "guided", ["You need 5 Dolla.", "An opponent must own an eligible Red item."])],
  [196, rule("Close Rooney’s Weapons Emporium until another store card reopens it.", false, "automatic")],
  [197, rule("Place a bounty and a Dolla donation on a bunny. Players may add to it; whoever kills that bunny collects the pooled Dolla.", true, "manual")],
  ...
  [200, rule("Attack the aliens holding abducted bunnies and roll the Yellow d12; the printed result may fail, destroy the aliens and captives, or also crash wreckage onto the owner’s Bunny Circle.", false, "manual", ["At least one bunny must currently be abducted."])],
  [201, rule("For this turn, buy items from Rooney’s Weapons Emporium for half price, rounding fractional Dolla up.", false, "guided", ["Rooney’s Weapons Emporium must be open."])],
  [202, rule("Make every opponent reveal bunnies in their five-card hand, then optionally trade one card from your hand for one revealed bunny.", false, "guided")],
  [203, rule("Protect a bunny from a Weapon by moving it out of play for three rounds; it returns at the start of its owner’s third turn.", true, "manual", ["A bunny must currently be threatened by a Weapon."])],
  [204, rule("Cancel any Terrible, Very Terrible, or Extremely Terrible Misfortune as it is drawn.", false, "guided", ["A Terrible Misfortune must be resolving."])],
  [207, rule("A first-time player takes one saved Special or Very Special from each adjacent player; otherwise pass this card to the next first-time player or use it yourself if none exist.", false, "guided")],
]);
...
export function getKillerBunniesCardRules(card) {
  ...
  const communityRule = shouldUseCommunityRule(card, wiki)
    ...
    : null;
  const base = publisherRule || crossCheckedRule || setupRule || communityRule || inferCardRule(effectiveCard);
  ...
  return Object.freeze({
    ...
    abilitySource: publisherRule ? "publisher" : crossCheckedRule ? "cross-checked" : communityRule && !setupRule ? "community" : "family-rule",
...
function barrierRule() {
  return rule("Place a Barrier between adjacent players. It blocks adjacent Weapon spillover and reverses Roaming Red RUN cards that reach it.", false, "manual");
}
