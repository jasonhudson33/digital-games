...
export const ROUTES = [
  ...
  route("phoenix-denver", "phoenix", "denver", "white", 5),
  ...
  route("helena-denver", "helena", "denver", "green", 4),
...
export function chooseOpeningDestinations(game, playerId, destinationIds) {
  ...
  return {
    ...
    log: [everyoneReady ? `${players[game.currentPlayerIndex].name} takes the first turn.` : `${player.name} locked in their destinations.`, ...game.log].slice(0, 40),
  };
}
