...
const CATALOGUE = [
  ...
  },
  {
    ...
    hue: 205,
    isNew: true,
    blurb: "Build books and runs across five suits, chase the rotating wild rank, and finish with the lowest score.",
  },
  {
    slug: "hand-and-foot",
    name: "Hand and Foot",
  ...
  },
  {
    ...
    hue: 180,
    isNew: true,
    blurb: "Complete ten escalating sets, runs, and color phases while keeping your score low.",
  },
  {
    slug: "pinochle",
    name: "Pinochle",
  ...
  },
  {
    ...
    hue: 45,
    isNew: true,
    blurb: "Deploy a hidden army, read the enemy formation, and fight through the ranks to capture the Flag.",
  },
  {
    slug: "ticket-to-ride",
    name: "Ticket to Ride",
